...
**Important note** Unlike the rest of the code on this course, we had to use version 7 of jsPsych for this one - version 8 is brand new, they removed one of the functions that we need for this code to work (`addNodeToEndOfTimeline`) and while [they are working on putting it back](https://github.com/jspsych/jsPsych/issues/3379), it hasn't come together quite in time. Version 7 is very similar to version 8 - there are some very small differences in how we add fields to the data generated by each trial, but you probably won't notice much difference!
